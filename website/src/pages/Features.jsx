...
import { Zap, Globe, AlertTriangle, RefreshCw, Bell, Shield, LineChart, Database, Server, GitBranch } from 'lucide-react';
    ...
    <Layout>
      ...
      <section className="section">
        <div className="section-header">
          <h2 className="section-title">Flexible Architecture</h2>
        ...
        <div className="cta-content">
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link to="/pricing" className="btn-secondary">
              <GitBranch size={18} /> View Pricing
            </Link>
          </div>
        </div>
      </section>
