...
import { Zap, GitBranch, Globe, AlertTriangle, RefreshCw, Bell, Shield, LineChart, Database, Server, Terminal, ArrowRight, Check } from 'lucide-react';
    ...
    <Layout>
      ...
      <section className="hero">
        ...
        <p className="hero-subtitle">
          Stop digging through scattered GitHub Actions logs. Get a centralized dashboard
          that shows pipeline health across all your repositories in real-time.
        </p>
      ...
      <section style={{ padding: '40px 24px', textAlign: 'center' }}>
        <p style={{ color: 'var(--text-dim)', fontSize: '13px', textTransform: 'uppercase', letterSpacing: '2px', marginBottom: '32px' }}>
          Trusted by DevOps teams worldwide
        </p>
        <div className="tech-grid">
          <div className="tech-item"><Database size={18} /> SQLite</div>
          <div className="tech-item"><Database size={18} /> PostgreSQL</div>
          <div className="tech-item"><Globe size={18} /> WebSockets</div>
          <div className="tech-item"><Shield size={18} /> GitHub OAuth</div>
        </div>
      </section>
      ...
      <section className="section">
        <div className="section-header">
          ...
          <h2 className="section-title">CI/CD Visibility is Broken</h2>
          <p className="section-subtitle">
            Teams waste hours every week hunting through logs. There's a better way.
          </p>
        </div>
